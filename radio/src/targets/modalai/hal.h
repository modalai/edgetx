...
// #define RADIO_MODAL_PROTOTYPE

#if defined(RADIO_MODAL_PROTOTYPE)
...
#else // Full zorro build

// Keys

#define KEYS_GPIO_REG_PAGEUP          GPIOB
#define KEYS_GPIO_PIN_PAGEUP          LL_GPIO_PIN_9 // PB.09
#define KEYS_GPIO_REG_PAGEDN          GPIOB
#define KEYS_GPIO_PIN_PAGEDN          LL_GPIO_PIN_8 // PB.08
#define KEYS_GPIO_REG_EXIT            GPIOB
#define KEYS_GPIO_PIN_EXIT            LL_GPIO_PIN_7 // PB.07
#define KEYS_GPIO_REG_ENTER           GPIOC
#define KEYS_GPIO_PIN_ENTER           LL_GPIO_PIN_8  // PC.08
#define KEYS_GPIO_REG_SYS             GPIOB
#define KEYS_GPIO_PIN_SYS             LL_GPIO_PIN_6  // PB.06
#define KEYS_GPIO_REG_MDL             GPIOD
#define KEYS_GPIO_PIN_MDL             LL_GPIO_PIN_2  // PD.02
#define KEYS_GPIO_REG_TELE            GPIOE
#define KEYS_GPIO_PIN_TELE            LL_GPIO_PIN_8  // PE.08

// Rotary Encoder

#define ROTARY_ENCODER_NAVIGATION
#define ROTARY_ENCODER_GPIO              GPIOC
#define ROTARY_ENCODER_GPIO_PIN_A        LL_GPIO_PIN_12 // PC.12
#define ROTARY_ENCODER_GPIO_PIN_B        LL_GPIO_PIN_9 // PC.09
...
// #warning Backlight settings
#define BACKLIGHT_TIMER_FREQ          (PERI1_FREQUENCY * TIMER_MULT_APB1)
#define BACKLIGHT_TIMER               TIM13
#define BACKLIGHT_GPIO                GPIO_PIN(GPIOF, 8) // PF.08
#define BACKLIGHT_GPIO_AF             GPIO_AF9
#define BACKLIGHT_CCMR1               TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_2 // Channel1, PWM
#define BACKLIGHT_CCER                TIM_CCER_CC1E
#define BACKLIGHT_COUNTER_REGISTER    BACKLIGHT_TIMER->CCR1
...
#endif // External Hardware Config
...
//SD - SDIO
// don't use DMA, use IDMA on peripheral

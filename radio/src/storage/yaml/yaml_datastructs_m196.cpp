...
const struct YamlIdStr enum_BootMenuModes[] = {
  {  BOOT_MENU_TELEMETRY, "MENU_TELEMETRY"  },
  {  BOOT_MENU_MAIN, "MENU_MAIN"  },
  {  BOOT_MENU_HUB, "MENU_HUB"  },
  {  0, NULL  }
};
...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_ENUM("bootMenu", 2, enum_BootMenuModes, NULL),
  YAML_PADDING( 1 ),
...
static const struct YamlNode struct_ModelData[] = {
  ...
  YAML_ARRAY("customSwitches", 32, 5, struct_customSwitch, isAlwaysActive),

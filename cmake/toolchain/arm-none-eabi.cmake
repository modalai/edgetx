...
set(CMAKE_C_FLAGS_DEBUG_INIT "-ggdb3 -O0 -Wall -pedantic -DDEBUG --specs=rdimon.specs")
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG_INIT}" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELEASE_INIT "-O3 -Wall")
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE_INIT}" CACHE STRING "" FORCE)

# Default C++ compiler flags
set(CMAKE_CXX_FLAGS_DEBUG_INIT "-ggdb3 -O0 -Wall -pedantic -DDEBUG --specs=rdimon.specs")
...
set(LINK_FLAGS "${LINK_FLAGS} -Wl,-lc -Wl,-lrdimon --specs=rdimon.specs")
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--print-memory-usage -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections")
...
set(CMAKE_C_LINK_FLAGS "${CMAKE_C_LINK_FLAGS} -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -Wl,-lc -Wl,-lrdimon")
